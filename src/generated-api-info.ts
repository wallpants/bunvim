...
export type ApiInfo = {
    ...
    nvim_buf_create_user_command: {
        parameters: [buffer: number, name: string, command: unknown, opts: Record<string, unknown>];
        returns: void;
    };
    ...
    nvim_select_popupmenu_item: {
        parameters: [item: number, insert: boolean, finish: boolean, opts: Record<string, unknown>];
        returns: void;
    };
    nvim_del_mark: {
        parameters: [name: string];
